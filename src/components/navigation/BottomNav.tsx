...
const BottomNav = () => {
  return (
    ...
    >
      <div className="relative glass-strong rounded-2xl px-2 sm:px-3 py-2 shadow-elevated flex flex-row items-center justify-center pointer-events-auto mx-4 max-w-[calc(100%-32px)]">
        ...
        {navItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                "relative flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 rounded-xl transition-all duration-300 ease-smooth flex-shrink-0",
                isActive
                  ? "text-primary"
