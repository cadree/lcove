...
const PostCreator = ({ avatarUrl, displayName }: PostCreatorProps) => {
  const { user } = useAuth();
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <Textarea
            ...
            className="min-h-[60px] resize-none bg-transparent border-none text-foreground placeholder:text-muted-foreground focus-visible:ring-0 p-0"
          />
        </div>
      </div>
