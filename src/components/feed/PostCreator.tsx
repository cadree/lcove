...
const PostCreator = ({
  ...
  return <motion.div layout className="glass-strong p-4 mb-6 rounded-3xl">
      ...
      <div className="flex items-start gap-3">
        ...
        }} onFocus={() => setIsExpanded(true)} className="min-h-[60px] resize-none bg-transparent border-none text-foreground placeholder:text-muted-foreground focus-visible:ring-0 px-4 py-2" />
        </div>
      </div>
