...
// Get anchor point from DOM element
...
const ConnectorPath = memo(function ConnectorPath({
  ...
  // Update path using RAF for smooth performance
  ...
  // Initial render and listen for drag events
  useEffect(() => {
    updatePath();
  ...
  // Update when canvas offset changes
  useEffect(() => {
    updatePath();
...
export const ConnectorLayerOptimized = memo(function ConnectorLayerOptimized({
  items,
  offset,
  selectedConnectorId,
  onSelectConnector,
  ...
  // Calculate canvas offset for DOM queries
