...
const Index = () => {
  ...
  return <div className="min-h-screen bg-background overflow-x-hidden pb-24">
      ...
      paddingTop: "max(env(safe-area-inset-top, 0px), 0px)"
        ...
        <div className="flex items-center justify-between px-4 h-14 relative">
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="icon" className="h-9 w-9 text-muted-foreground hover:text-foreground" onClick={handleBack} aria-label="Go back">
      ...
      <main className="pt-[calc(3.5rem+env(safe-area-inset-top))] px-4 space-y-6">
        ...
        <HomeEditSheet open={isEditing} onOpenChange={setIsEditing} autoReorder={home.preferences.auto_reorder} onToggleAutoReorder={home.toggleAutoReorder} onReset={home.resetPersonalization} />

        <HomePinnedSection items={home.pinnedItems} isEditing={isEditing} onTogglePin={home.togglePin} onItemClick={handleItemClick} />
